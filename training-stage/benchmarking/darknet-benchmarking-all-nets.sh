...
python3 darknet_2_coco_detections.py ./assets/PPU-6-416.json results-yolov4-tiny-416.txt \
    results-yolov4-tiny-416.json

python3 darknet_2_coco_detections.py ./assets/PPU-6-416.json results-yolov4-tiny-3l-416.txt \
    results-yolov4-tiny-3l-416.json

python3 darknet_2_coco_detections.py ./assets/PPU-6-416.json results-yolov4-416.txt \
    results-yolov4-416.json

python3 darknet_2_coco_detections.py ./assets/PPU-6-512.json results-yolov4-csp-512.txt \
    results-yolov4-csp-512.json

python3 darknet_2_coco_detections.py ./assets/PPU-6-640.json results-yolov4x-mish-640.txt \
...
mv ./generated-files-dump/MAP-table.txt ./
